...
from reader.formatter.SFKS.Comatching import ComatchingFormatter4
...
from reader.formatter.ljp.ljp import LJPBertFormatter
...
def init_formatter(config):
    ...
    useable_list = {
        ...
        "SFKS_comatching4": ComatchingFormatter4,
        ...
        "LJPBertFormatter": LJPBertFormatter
    }
