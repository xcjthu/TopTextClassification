...
class DSQAFormatter:
    def __init__(self, config):
        ...
        self.que_opt_len = self.que_len + self.opt_len
    ...
    def format(self, data, config, transformer, mode):
        ...
        for temp_data in data:
            A = temp_data["statement"] + temp_data["option_list"]["A"]
            B = temp_data["statement"] + temp_data["option_list"]["B"]
            C = temp_data["statement"] + temp_data["option_list"]["C"]
            D = temp_data["statement"] + temp_data["option_list"]["D"]
            tmp = []
            
            tmp.append(self.lookup(A, self.que_opt_len, transformer))
            tmp.append(self.lookup(B, self.que_opt_len, transformer))
            tmp.append(self.lookup(C, self.que_opt_len, transformer))
            tmp.append(self.lookup(D, self.que_opt_len, transformer))
